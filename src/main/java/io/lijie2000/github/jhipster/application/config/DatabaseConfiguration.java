...
@Configuration
@EnableJpaRepositories("io.lijie2000.github.jhipster.application.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("io.lijie2000.github.jhipster.application.repository.search")
